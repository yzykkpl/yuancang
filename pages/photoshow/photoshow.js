...
Page({
  ...
  onLoad: function (options) {
    ...
    switch(id){
      ...
      case '2':
        that.setData({
          url: 'https://yuancang-1256086874.cos.ap-chengdu.myqcloud.com/yc/images/photograph/travel.jpg'
        })
        break;
      case '3':
        that.setData({
          url: 'https://yuancang-1256086874.cos.ap-chengdu.myqcloud.com/yc/images/photograph/portrait.jpg'
        })
        break;
      case '4':
        that.setData({
